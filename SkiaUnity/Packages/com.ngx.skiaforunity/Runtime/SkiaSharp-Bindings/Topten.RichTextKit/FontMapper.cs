...
namespace Topten.RichTextKit
{
    ...
    public class FontMapper {
        ...
        public SKTypeface customBoldTypeface;
        public SKTypeface customItalicTypeface;
        public SKTypeface customBoldItalicTypeface;
        /// <summary>
        /// Constructs a new FontMapper instnace
        /// </summary>
        public FontMapper(
            SKTypeface custom = null,
            SKTypeface customBold = null,
            SKTypeface customItalic = null,
            SKTypeface customBoldItalic = null) {
            customSkTypeface = custom;
            customBoldTypeface = customBold;
            customItalicTypeface = customItalic;
            customBoldItalicTypeface = customBoldItalic;
        }
        ...
        public virtual SKTypeface TypefaceFromStyle(IStyle style, bool ignoreFontVariants)
        {
            ...
            if (customSkTypeface != null) {
                bool wantsBold = style.FontWeight + extraWeight >= 700;
                bool wantsItalic = style.FontItalic;

                if (wantsBold && wantsItalic && customBoldItalicTypeface != null)
                    return customBoldItalicTypeface;
                if (wantsItalic && customItalicTypeface != null)
                    return customItalicTypeface;
                if (wantsBold && customBoldTypeface != null)
