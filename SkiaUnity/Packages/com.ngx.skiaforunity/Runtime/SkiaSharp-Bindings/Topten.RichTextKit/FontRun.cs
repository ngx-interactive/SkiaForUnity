            ...
            using (var paintHalo = new SKPaint())
            {
                ...
                unsafe
                {
                    fixed (ushort* pGlyphs = Glyphs.Underlying)
                    {
                        ...
                        // Keep the run font synced and provide synthetic styling when
                        // a custom typeface has no bold/italic variant.
                        _font.Typeface = this.Typeface;
                        bool needsFakeBold = Style.FontWeight >= 700 && this.Typeface != null && this.Typeface.FontWeight < 700;
                        bool needsFakeItalic = Style.FontItalic && this.Typeface != null && this.Typeface.FontSlant == SKFontStyleSlant.Upright;
                        _font.Embolden = needsFakeBold;
                        _font.SkewX = needsFakeItalic ? -0.25f : SKFont.DefaultSkewX;
